...
///
/// Thread-safe via `OSAllocatedUnfairLock`. Observes `com.andrijvergeles.auraflow.prefsChanged`
...
final class WallpaperPrefs: @unchecked Sendable {
    ...
    func observeChanges() {
        ...
        CFNotificationCenterAddObserver(
            ...
            "com.andrijvergeles.auraflow.prefsChanged" as CFString,
            nil,
            .deliverImmediately,
        )
    }
    ...
    func stopObserving() {
        ...
        CFNotificationCenterRemoveObserver(
            center,
            observer,
            CFNotificationName("com.andrijvergeles.auraflow.prefsChanged" as CFString),
            nil,
        )
    }
    ...
    private func postStateNotification() {
        ...
        CFNotificationCenterPostNotification(
            center,
            CFNotificationName("com.andrijvergeles.auraflow.stateChanged" as CFString),
            nil,
            nil,
            true,
        )
